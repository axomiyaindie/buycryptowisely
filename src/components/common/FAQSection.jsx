...
import { COLORS, SPACING, BORDER_RADIUS, ANIMATIONS, FONTS } from '../../utils/constants';

export const FAQSection = ({ translations }) => {
  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", marginBottom: SPACING.xl }}>
        <h2 style={{ fontSize: "clamp(28px, 5vw, 42px)", fontWeight: 700, color: COLORS.text }}>
